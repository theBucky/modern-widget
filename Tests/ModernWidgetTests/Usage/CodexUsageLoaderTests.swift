...
struct CodexUsageLoaderTests {
    @Test(
        "prices every OpenAI model family in the catalog",
        arguments: [
            (model: "gpt-5.3-codex", inputCost: 1.75),
            (model: "gpt-5.4", inputCost: 2.5),
            (model: "gpt-5.4-mini", inputCost: 0.75),
            (model: "gpt-5.4-nano", inputCost: 0.2),
            (model: "gpt-5.5", inputCost: 5.0),
            (model: "gpt-5.6-sol", inputCost: 5.0),
            (model: "gpt-5.6-terra", inputCost: 2.5),
            (model: "gpt-5.6-luna", inputCost: 1.0),
        ])
